...
import { SET_ALL_JOB_POSTS,SET_ERRORS, 
    CLEAR_ERRORS, LOADING_UI,
     SET_UNAUTHENTICATED,
     LOADING_USER, SET_AUTHENTICATED, SET_USER, MARK_NOTIFICATIONS_READ} from '../types'
...
export const markNotificationsRead = (notificationIds) => dispatch => {
    axios.post('https://australia-southeast1-workservices-e4506.cloudfunctions.net/api/notifications', notificationIds)
    .then(res => {
        dispatch({
