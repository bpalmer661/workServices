...
//REPLY TO A JOB POST
export const replyToAJobPost = (jobPostDetails,jobPostId) => dispatch => {
     
    axios.post(`https://australia-southeast1-workservices-e4506.cloudfunctions.net/api/JobPost/${jobPostId}`,jobPostDetails)
    .then(res => {
        dispatch({
